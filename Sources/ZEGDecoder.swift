...
public class ZEGDecoder {
	...
	static func decodeUpdate(jsonString: String) -> Update? {
		...
		do {
			...
			return try decodeUpdate(jsonConvertibleObject: jsonConvertibleObject)
	...
	static func decodeUpdate(jsonConvertibleObject: Any?) throws -> Update {
		...
		/* OPTIONAL */
		let message: Message? = decodeMessage(jsonConvertibleObject: jsonDictionary["message"])
		let edited_message: Message? = decodeMessage(jsonConvertibleObject: jsonDictionary["edited_message"])
	...
	static func decodeMessage(jsonConvertibleObject: Any?) -> Message? {
		...
		do {
			...
			let message: Message = try decodeMessage(jsonConvertibleObject: jsonConvertibleObject)
			return message
	...
	static func decodeMessage(jsonConvertibleObject: Any?) throws -> Message {
		...
		do {
			...
			chat = try decodeChat(jsonConvertibleObject: jsonDictionary["chat"])
		...
		/* OPTIONAL. */
		let from: User? = decodeUser(jsonConvertibleObject: jsonDictionary["from"])
		let forward_from: User? = decodeUser(jsonConvertibleObject: jsonDictionary["forward_from"])
		let forward_from_chat: Chat? = decodeChat(jsonConvertibleObject: jsonDictionary["forward_from_chat"])
		let forward_date = jsonDictionary["forward_date"] as? Int
		let reply_to_message: Message? = decodeMessage(jsonConvertibleObject: jsonDictionary["reply_to_message"])
		let edit_date = jsonDictionary["edit_date"] as? Int
		let text = jsonDictionary["text"] as? String
		let entities: [MessageEntity]? = decodeMessageEntitiesArray(jsonConvertibleObject: jsonDictionary["entities"])
		let audio: Audio? = decodeAudio(jsonConvertibleObject: jsonDictionary["audio"])
		let document: Document? = decodeDocument(jsonConvertibleObject: jsonDictionary["document"])
		let photo: [PhotoSize]? = decodePhotoSizeArray(jsonConvertibleObject: jsonDictionary["photo"])
		let sticker: Sticker? = decodeSticker(jsonConvertibleObject: jsonDictionary["sticker"])
		let video: Video? = decodeVideo(jsonConvertibleObject: jsonDictionary["video"])
		let voice: Voice? = decodeVoice(jsonConvertibleObject: jsonDictionary["voice"])
		let caption = jsonDictionary["caption"] as? String
		let contact: Contact? = decodeContact(jsonConvertibleObject: jsonDictionary["contact"])
		let location: Location? = decodeLocation(jsonConvertibleObject: jsonDictionary["location"])
		let venue: Venue? = decodeVenue(jsonConvertibleObject: jsonDictionary["venue"])
		let new_chat_member: User? = decodeUser(jsonConvertibleObject: jsonDictionary["new_chat_member"])
		let left_chat_member: User? = decodeUser(jsonConvertibleObject: jsonDictionary["left_chat_member"])
		let new_chat_title = jsonDictionary["new_chat_title"] as? String
		let new_chat_photo: [PhotoSize]? = decodePhotoSizeArray(jsonConvertibleObject: jsonDictionary["new_chat_photo"])
		...
		let pinned_message: Message? = decodeMessage(jsonConvertibleObject: jsonDictionary["pinned_message"])
	...
	static func decodeChat(jsonConvertibleObject: Any?) -> Chat? {
		...
		do {
			...
			let chat: Chat = try decodeChat(jsonConvertibleObject: jsonConvertibleObject)
			return chat
	...
	static func decodeUser(jsonConvertibleObject: Any?) -> User? {
		...
		do {
			...
			let user: User = try decodeUser(jsonConvertibleObject: jsonConvertibleObject)
			return user
	...
	static func decodeMessageEntitiesArray(jsonConvertibleObject: Any?) -> [MessageEntity]? {
		...
		do {
			...
			let messageEntitiesArray: [MessageEntity] = try decodeMessageEntitiesArray(jsonConvertibleObject: jsonConvertibleObject)
	...
	static func decodeMessageEntitiesArray(jsonConvertibleObject: Any?) throws -> [MessageEntity] {
		...
		for entity in jsonArray {
			...
			do {
				...
				let messageEntity: MessageEntity = try decodeMessageEntity(jsonConvertibleObject: entity)
	...
	static func decodeAudio(jsonConvertibleObject: Any?) -> Audio? {
		...
		do {
			...
			let audio: Audio = try decodeAudio(jsonConvertibleObject: jsonConvertibleObject)
			return audio
	...
	static func decodeDocument(jsonConvertibleObject: Any?) -> Document? {
		...
		do {
			...
			let document: Document = try decodeDocument(jsonConvertibleObject: jsonConvertibleObject)
			return document
	...
	static func decodeDocument(jsonConvertibleObject: Any?) throws -> Document {
		...
		/* OPTIONAL. */
		let thumb: PhotoSize? = decodePhotoSize(jsonConvertibleObject: jsonDictionary["thumb"])
	...
	static func decodePhotoSize(jsonConvertibleObject: Any?) -> PhotoSize? {
		...
		do {
			...
			let photoSize: PhotoSize = try decodePhotoSize(jsonConvertibleObject: jsonConvertibleObject)
			return photoSize
	...
	static func decodePhotoSizeArray(jsonConvertibleObject: Any?) -> [PhotoSize]? {
		...
		do {
			...
			let photoSizeArray: [PhotoSize] = try decodePhotoSizeArray(jsonConvertibleObject: jsonConvertibleObject)
	...
	static func decodePhotoSizeArray(jsonConvertibleObject: Any?) throws -> [PhotoSize] {
		...
		for photoSizeObject in jsonArray {
			...
			do {
				...
				let photoSize: PhotoSize = try decodePhotoSize(jsonConvertibleObject: photoSizeObject)
	...
	static func decodeSticker(jsonConvertibleObject: Any?) -> Sticker? {
		...
		do {
			...
			let sticker: Sticker = try decodeSticker(jsonConvertibleObject: jsonConvertibleObject)
			return sticker
	...
	static func decodeVideo(jsonConvertibleObject: Any?) -> Video? {
		...
		do {
			...
			let video: Video = try decodeVideo(jsonConvertibleObject: jsonConvertibleObject)
			return video
	...
	static func decodeVoice(jsonConvertibleObject: Any?) -> Voice? {
		...
		do {
			...
			let voice: Voice = try decodeVoice(jsonConvertibleObject: jsonConvertibleObject)
			return voice
	...
	static func decodeContact(jsonConvertibleObject: Any?) -> Contact? {
		...
		do {
			...
			let contact: Contact = try decodeContact(jsonConvertibleObject: jsonConvertibleObject)
			return contact
	...
	static func decodeLocation(jsonConvertibleObject: Any?) -> Location? {
		...
		do {
			...
			let location: Location = try decodeLocation(jsonConvertibleObject: jsonConvertibleObject)
			return location
	...
	static func decodeVenue(jsonConvertibleObject: Any?) -> Venue? {
		...
		do {
			...
			let venue: Venue = try decodeVenue(jsonConvertibleObject: jsonConvertibleObject)
			return venue
	...
	static func decodeVenue(jsonConvertibleObject: Any?) throws -> Venue {
		...
		do {
			...
			location = try decodeLocation(jsonConvertibleObject: jsonDictionary["location"])
...
public enum ZEGDecoderError: ErrorProtocol {
